...
//-----------Sign In ------------
    ...
    public ResponseEntity<VaccinationCenter> getVaccineCenter(@PathVariable("centerId") Integer centerId) throws VaccinationCenterException {
    ...
    public ResponseEntity<VaccinationCenter> addVaccinationCenter(@RequestBody @Valid VaccinationCenter center) throws VaccinationCenterException {
    ...
    public ResponseEntity<VaccinationCenter> updateVaccinationCenter(@RequestBody @Valid VaccinationCenter center,@PathVariable Integer centerId) throws VaccinationCenterException {
    ...
    public ResponseEntity<Boolean> deleteVaccinationCenter(@PathVariable Integer centerId) throws VaccinationCenterException {
    ...
    public ResponseEntity<IdCard> getPanCardByNumber(@RequestParam String panNumber){
        IdCard id = memberService.findMemberByPanCard(panNumber);
    ...
    public ResponseEntity<IdCard> getIdCardByAadharNumber(@RequestParam String aadharNumber){
        IdCard id = memberService.findMemberByAadharCard(aadharNumber);
        return new ResponseEntity<IdCard>(id,HttpStatus.ACCEPTED);
    }

    @PostMapping("/addIdCard")
    public ResponseEntity<IdCard> addIdCard(@Valid @RequestBody IdCard idCard){
        IdCard id = idCardService.registerNewMember(idCard);
        return new ResponseEntity<IdCard>(id,HttpStatus.ACCEPTED);
    }
